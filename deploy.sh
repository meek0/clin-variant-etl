...
aws s3 --profile cqgc --no-verify-ssl --endpoint-url https://minio-cqgc.infojutras.com cp src/main/resources/templates s3://cqgc-qa-app-datalake/jobs/templates/ --recursive