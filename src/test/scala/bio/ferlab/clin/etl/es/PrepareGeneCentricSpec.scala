...
class PrepareGeneCentricSpec extends AnyFlatSpec with GivenWhenThen with WithTestConfig with WithSparkSession with Matchers {
  ...
  "Gene_centric transform" should "return data as GeneCentricOutput" in {
    ...
    result.as[GeneCentricOutput].collect() should contain allElementsOf Seq(
      GeneCentricOutput(symbol = "OR4F4", `entrez_gene_id` = 0, `omim_gene_id` = null, `hgnc` = null, `ensembl_gene_id` = null, `location` = null, name= null, `alias` = List(), `biotype` = null, `orphanet` = null,hpo=null,`omim` = null, chromosome=null, ddd=null, cosmic=null, `number_of_patients` = 2, `number_of_patients_cnvs` = 1, `number_of_variants_per_patient` = List(VARIANT_PER_PATIENT("PA0002", 1), VARIANT_PER_PATIENT("PA0001", 1)), `number_of_cnvs_per_patient` = List(VARIANT_PER_PATIENT("PA0001", 1)), hash="63592aea532cb1c022cbc13ea463513df18baf57"),
      GeneCentricOutput(symbol = "OR4F5", `number_of_patients` = 3, `number_of_variants_per_patient` = List(VARIANT_PER_PATIENT("PA0003", 1), VARIANT_PER_PATIENT("PA0001", 1), VARIANT_PER_PATIENT("PA0002", 2)), `number_of_patients_cnvs` = 2, `number_of_cnvs_per_patient` = List(VARIANT_PER_PATIENT("PA0001", 1), VARIANT_PER_PATIENT("PA0002", 1))),
      GeneCentricOutput(symbol = "OR4F6", `number_of_patients` = 0, `number_of_variants_per_patient` = List(), `number_of_patients_cnvs` = 0,  `number_of_cnvs_per_patient` = List(), hash = "026aba5120030fcfbc29ebed8b2a1d78f90c07ad"),
      GeneCentricOutput(symbol = "OR4F7", `entrez_gene_id` = 0, `omim_gene_id` = null, `hgnc` = null, `ensembl_gene_id` = null, `location` = null, name= null, `alias` = List(), `biotype` = null, `orphanet` = null,hpo=null,`omim` = null, chromosome=null, ddd=null, cosmic=null, `number_of_patients` = 0, `number_of_variants_per_patient` = List(), `number_of_patients_cnvs` = 1, `number_of_cnvs_per_patient` = List(VARIANT_PER_PATIENT("PA0001", 1)), hash="0bec4c2958cfbbfe4a212deef68da5d6eaf5ee29"))
  }
}
