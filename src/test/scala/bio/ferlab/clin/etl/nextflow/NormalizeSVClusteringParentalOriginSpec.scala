...
class NormalizeSVClusteringParentalOriginSpec extends SparkSpec with WithTestConfig with CleanUpBeforeEach {
  ...
  val clinicalDf: DataFrame = Seq(
    // Analysis 1
    EnrichedClinical(`patient_id` = "PA0001", `analysis_id` = analysis1Id, `sequencing_id` = "SRS0001", `batch_id` = batchId, `aliquot_id` = "11111", `is_proband` = true, `gender` = "Male", `affected_status` = true, `family_id` = Some("FM00001"), `mother_id` = Some("PA0003"), `father_id` = Some("PA0002")), // proband
    EnrichedClinical(`patient_id` = "PA0002", `analysis_id` = analysis1Id, `sequencing_id` = "SRS0002", `batch_id` = batchId, `aliquot_id` = "22222", `is_proband` = false, `gender` = "Male", `affected_status` = false, `family_id` = Some("FM00001"), `mother_id` = None, `father_id` = None), // father
    EnrichedClinical(`patient_id` = "PA0003", `analysis_id` = analysis1Id, `sequencing_id` = "SRS0003", `batch_id` = batchId, `aliquot_id` = "33333", `is_proband` = false, `gender` = "Female", `affected_status` = true, `family_id` = Some("FM00001"), `mother_id` = None, `father_id` = None), // mother

    // Analysis 2
    EnrichedClinical(`patient_id` = "PA0004", `analysis_id` = analysis2Id, `sequencing_id` = "SRS0004", `batch_id` = batchId, `aliquot_id` = "44444", `is_proband` = true, `gender` = "Male", `affected_status` = true, `family_id` = Some("FM00002"), `mother_id` = Some("PA0006"), `father_id` = Some("PA0005")), // proband
    EnrichedClinical(`patient_id` = "PA0005", `analysis_id` = analysis2Id, `sequencing_id` = "SRS0005", `batch_id` = batchId, `aliquot_id` = "55555", `is_proband` = false, `gender` = "Male", `affected_status` = false, `family_id` = Some("FM00002"), `mother_id` = None, `father_id` = None), // father
    EnrichedClinical(`patient_id` = "PA0006", `analysis_id` = analysis2Id, `sequencing_id` = "SRS0006", `batch_id` = batchId, `aliquot_id` = "66666", `is_proband` = false, `gender` = "Female", `affected_status` = true, `family_id` = Some("FM00002"), `mother_id` = None, `father_id` = None), // mother
  ).toDF
  ...
  it should "normalize svclustering parental origin results" in {
    withOutputFolder("root") { root =>
      ...
      // Load input data to get input file name, since input file name is used to extract analysis_id
      allAnalysisResults.foreach { case (analysis_id, df) =>
        val dsPath = raw_variant_calling.path
        val updatedDsPath = dsPath
          .replace("{{BATCH_ID}}", batchId)
          .replace("svclustering*/*.vcf.gz", s"svclusteringdel/$analysis_id.MAX_CLIQUE_RO80.DEL.vcf.gz")
      ...
      result
        ...
        // Analysis 1
        SVClusteringParentalOrigin(`batch_id` = batchId, `analysis_id` = analysis1Id, `sequencing_id` = "SRS0001",
        ...
        SVClusteringParentalOrigin(`batch_id` = batchId, `analysis_id` = analysis1Id, `sequencing_id` = "SRS0002",
        ...
        SVClusteringParentalOrigin(`batch_id` = batchId, `analysis_id` = analysis1Id, `sequencing_id` = "SRS0003",
        ...
        // Analysis 2
        SVClusteringParentalOrigin(`batch_id` = batchId, `analysis_id` = analysis2Id, `sequencing_id` = "SRS0004",
        ...
        SVClusteringParentalOrigin(`batch_id` = batchId, `analysis_id` = analysis2Id, `sequencing_id` = "SRS0005",
        ...
        SVClusteringParentalOrigin(`batch_id` = batchId, `analysis_id` = analysis2Id, `sequencing_id` = "SRS0006",
