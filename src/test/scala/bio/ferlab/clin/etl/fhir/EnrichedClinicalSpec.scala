...
class EnrichedClinicalSpec extends SparkSpec with WithTestConfig {
  ...
  val documentDf: DataFrame = Seq(
    ...
    NormalizedDocumentReference(id = "1-1-G-GCNV", patient_id = "PA0001", `type` = "GCNV", contents = List(Content(format = "VCF", s3_url = "s3a://1-1.vcf"), Content(format = "VCF", s3_url = "s3a://1-2.vcf"))),
    ...
    NormalizedDocumentReference(id = "2-2-G-GCNV", patient_id = "PA0002", `type` = "GCNV", contents = List(Content(format = "VCF", s3_url = "s3a://2-1.vcf"), Content(format = "VCF", s3_url = "s3a://2-2.vcf"))),
    ...
    NormalizedDocumentReference(id = "3-3-G-GCNV", patient_id = "PA0003", `type` = "GCNV", contents = List(Content(format = "VCF", s3_url = "s3a://3-1.vcf"), Content(format = "VCF", s3_url = "s3a://3-2.vcf"))),
