...
case class VCFInput(`contigName`: String = "chr1",
                    ...
                    `INFO_DP`: Int = 330,
                    `INFO_VQSLOD`: Double = -31.9246,
                    `INFO_MQ`: Double = 15.54,
                    `INFO_QD`: Double = 8.07,
                    `INFO_END`: Option[Int] = None,
                    `INFO_CSQ`: List[INFO_CSQ] = List(bio.ferlab.clin.model.INFO_CSQ()),
                    `INFO_DB`: Boolean = true,
                    `INFO_MQRankSum`: Double = 2.054,
                    `INFO_FractionInformativeReads`: Option[Double] = None,
                    `INFO_R2_5P_bias`: Option[Double] = None,
...
case class INFO_CSQ(`Allele`: String = "C",
                    ...
                    `EXON`: EXON = bio.ferlab.clin.model.EXON(Some(1), Some(1)),
                    `INTRON`: INTRON = bio.ferlab.clin.model.INTRON(None, None),
