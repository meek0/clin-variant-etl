...
case class EnrichedClinical(`sequencing_id`: String = "SRS0001",
                            ...
                            `exomiser_snv_urls`: Option[Set[String]] = None,
                            `exomiser_cnv_urls`: Option[Set[String]] = None,
                            `snv_vcf_germline_urls`: Option[Set[String]] = None,
                            `snv_vcf_somatic_urls`: Option[Set[String]] = None,
                            `cnv_vcf_germline_urls`: Option[Set[String]] = None,
                            `cnv_vcf_somatic_urls`: Option[Set[String]] = None,
