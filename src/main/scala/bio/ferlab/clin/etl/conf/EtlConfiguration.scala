...
object EtlConfiguration extends App {
  ...
  val sources =
    List(
      ...
      DatasetConf("normalized_variants"            , clin_datalake, "/normalized/variants"               , DELTA  , OverWritePartitionDynamic, partitionby = List("analysis_id", "bioinfo_analysis_code"), table = Some(TableConf("clin", "normalized_variants"))),
