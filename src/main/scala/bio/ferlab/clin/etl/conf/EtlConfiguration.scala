...
object EtlConfiguration extends App {
  ...
  val sources =
    List(
      ...
      DatasetConf("dbnsfp_scores"          , clin_datalake, "/public/dbnsfp/parquet/scores"                      , PARQUET, OverWrite, TableConf("clin", "dbnsfp_scores")),
      ...
      DatasetConf("gnomad_genomes_3_1_1"   , clin_datalake, "/public/gnomad/gnomad_genomes_3_1_1"                , PARQUET, OverWrite, TableConf("clin", "gnomad_genomes_3_1_1")),
      ...
      DatasetConf("normalized_variants"    , clin_datalake, "/normalized/variants"                        , DELTA  , Insert   , partitionby = List("chromosome"), table = Some(TableConf("clin", "normalized_variants"))),
      DatasetConf("normalized_consequences", clin_datalake, "/normalized/consequences"                    , DELTA  , Insert   , partitionby = List("chromosome"), table = Some(TableConf("clin", "normalized_consequences"))),
