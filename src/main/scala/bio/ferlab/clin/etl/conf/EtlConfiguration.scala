...
object EtlConfiguration extends App {
  ...
  val sources =
    List(
      ...
      DatasetConf("normalized_coverage_by_gene"    , clin_datalake, "/normalized/coverage_by_gene"       , DELTA  , OverWritePartition, partitionby = List("analysis_id")           , table = Some(TableConf("clin", "normalized_coverage_by_gene"))),
