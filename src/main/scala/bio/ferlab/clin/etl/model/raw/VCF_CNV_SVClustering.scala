...
case class VCF_CNV_SVClustering(`contigName`: String = "chr1",
                                `start`: Long = 9823628,
                                `end`: Long = 9823687,
                                ...
                                `genotypes`: Seq[GENOTYPES_CNV_SVCLUSTERING] = Seq(GENOTYPES_CNV_SVCLUSTERING()))

case class GENOTYPES_CNV_SVCLUSTERING(`sampleId`: String = "11111",
                                      `SM`: Double = 0.685086,
