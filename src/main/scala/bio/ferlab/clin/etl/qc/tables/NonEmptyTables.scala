...
object NonEmptyTables extends TestingApp {
  run { spark =>
    ...
    handleErrors(
      ...
      shouldNotBeEmpty(nextflow_svclustering_germline, "nextflow_svclustering_germline"),
      shouldNotBeEmpty(nextflow_svclustering_somatic, "nextflow_svclustering_somatic"),
