...
object NonEmptyTables extends TestingApp {
  run { spark =>
    ...
    handleErrors(
      shouldNotBeEmpty(gnomad_genomes_2_1_1, "gnomad_genomes_2_1_1"),
      shouldNotBeEmpty(gnomad_exomes_2_1_1, "gnomad_exomes_2_1_1"),
      shouldNotBeEmpty(gnomad_genomes_3_0, "gnomad_genomes_3_0"),
      shouldNotBeEmpty(gnomad_genomes_3_1_1, "gnomad_genomes_3_1_1"),
